 ...
 *
 * 61 entries. Canon's help states design INTENT and is not
...
export const CANON_HELP: Readonly<Record<string, ReadonlyArray<string>>> = Object.freeze({
  ...
  HLPBUY: Object.freeze([
    ...
    '',
    'buy [<number>] en/tro/mis/tor/ion/flu/foo/fig/dec/min/jam/zip/gol]',
    '               [<password>]',
    '',
  ...
  HLPPRI: Object.freeze([
    ...
    '',
    '  price [<number>] en/tro/mis/tor/ion/flu/foo/fig/dec/min/jam/zip/gol]',
    '',
    '  men  = price men',
    '  tro  = price troops',
    '  mis  = price missiles',
  ...
  HLPSCA: Object.freeze([
    ...
    '',
    '  scan e/sh/pl/ra/lo] [<ship letter>/<planet #>/<range>]',
    '',
  ...
  HLPSEL: Object.freeze([
    ...
    '',
    'Sell [<number>] en/tro/mis/tor/ion/flu/foo/fig/dec/min/jam/zip/gol]',
    '',
  ...
  HLPTRA: Object.freeze([
    ...
    '',
    '  transfer p/down] [<number>] en/tro/mis/tor/ion/flu/foo/fig/dec/min/jam]',
    '',
    '  men  = transfer men',
    '  tro  = transfer troops',
  ...
  HLPJET: Object.freeze([
    ...
    '',
    '  jettison LL/<number>] en/tro/mis/tor/ion/flu/foo/fig/dec/min/jam]',
    '',
    '  men  = transfer men',
    '  tro  = transfer troops',
    '  mis  = transfer missiles',
