 ...
 * `@ge/wire`. This file is kept as a historical spec artifact — a record of
 * what was DESIGNED under feature 003 — and is no longer read by any code.
 * Do not edit this file to track the live contract; edit `packages/wire`
 * instead.
 *
 * (Historical, no longer true: this file was once the canonical contract,
 * duplicated by hand into `frontend/src/types/contracts.ts` and kept in
 * parity by `frontend/test/contracts-parity.spec.ts`. Both of those are gone
 * — the frontend now imports `@ge/wire` directly — so there is nothing left
 * for this file to be kept identical to.)
 *
